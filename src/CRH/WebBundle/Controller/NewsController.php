...
use CRH\WebBundle\Entity\News;
use CRH\WebBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $news = $em->getRepository('CRHWebBundle:News')->findAll();
    ...
    {
        $news = new News();
        $form = $this->createForm('CRH\WebBundle\Form\NewsType', $news);
    ...
    {
        $deleteForm = $this->createDeleteForm($news);
        $editForm = $this->createForm('CRH\WebBundle\Form\NewsType', $news);
