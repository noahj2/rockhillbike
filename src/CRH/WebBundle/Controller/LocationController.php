...
use CRH\WebBundle\Entity\Location;
use CRH\WebBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $locations = $em->getRepository('CRHWebBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CRH\WebBundle\Form\LocationType', $location);
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('CRH\WebBundle\Form\LocationType', $location);
